...
from less.dataclassio import ioprepped
...
class ServerConfig:
    ...
    # Name of the server's host player that appears in the in-game
    # player list. If set, this overrides the host's display name
    # regardless of what the cloud assigns. If not set, party_name
    # is used instead.
    host_name: str = ''
