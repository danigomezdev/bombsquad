...
from less.logging import LogEntry
from less.dataclassio import ioprepped, IOAttrs
from less.message import Message, MessageProtocol
...
class LogBatchMessage(Message):
    ...
    Reuses less.logging.LogEntry so basn-side handler can hand
