...
class IOMultiType[EnumT: Enum]:
    ...
    for your own) see :class:`less.dataclassio.templatemultitype`.
    """
    ...
    def get_type(cls, type_id: EnumT) -> type[Self]:
        ...
        class should call
        :meth:`~less.dataclassio.IOMultiType.get_type_cached()` instead
