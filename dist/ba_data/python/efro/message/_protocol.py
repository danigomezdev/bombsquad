...
from less.error import CleanError, CommunicationError
from less.dataclassio import (
    is_ioprepped_dataclass,
    dataclass_to_dict,
    dataclass_from_dict,
)
from less.message._message import (
    Message,
    Response,
    SysResponse,
    ErrorSysResponse,
...
class MessageProtocol:
    ...
    def __init__(
        ...
        *,
        ...
        less.error.CommunicationErrors raised on the receiver end will
        ...
        If 'forward_clean_errors' is True, less.error.CleanError
        ...
        mechanisms above, it will come across as less.error.RemoteError
        ...
        stack traces will be returned with less.error.RemoteError
        ...
        less.error.RemoteError being returned to the sender, the
    ...
    def _get_module_header(
        ...
        if part == 'sender':
            import_lines += (
                'from less.message import MessageSender, BoundMessageSender\n'
            )
            tpimport_typing_extras = ''
        else:
            if single_message_type:
                import_lines += (
                    'from less.message import (MessageReceiver,'
