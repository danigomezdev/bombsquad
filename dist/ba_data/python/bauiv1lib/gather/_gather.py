...
class GatherWindow(bui.MainWindow):
    ...
    def __init__(
        ...
        from bauiv1lib.gather.publiclesstab import PublicLessGatherTab
        ...
        #     )
        tabdefs.append(
            (self.TabID.PUBLIC_LESS, bui.Lstr(value='Public (Less)'))
        )
        tabdefs.append(
        ...
        tabtypes: dict[GatherWindow.TabID, type[GatherTab]] = {
            ...
            self.TabID.PUBLIC_LESS: PublicLessGatherTab,
        }
