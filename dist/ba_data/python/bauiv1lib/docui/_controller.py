...
from less.util import asserttype
from less.error import CleanError, CommunicationError
from less.dataclassio import dataclass_to_json, dataclass_from_json
...
class DocUIController:
    ...
    def fulfill_request(self, request: DocUIRequest) -> DocUIResponse:
        ...
        :class:`less.error.CleanError` exception. This can be raised as a
