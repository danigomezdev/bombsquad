...
from less.call import CallbackSet
from less.dataclassio import dataclass_from_dict, dataclass_to_dict
...
if TYPE_CHECKING:
    ...
    from less.message import Message, Response, BoolResponse
