...
from less.util import utc_now, strip_exception_tracebacks
from less.terminal import Clr, color_enabled
from less.dataclassio import ioprepped, IOAttrs, dataclass_to_json
        ...
        if __debug__:
            ...
            if duration > 0.05 and (
                ...
                self._event_loop.call_soon_threadsafe(
                    partial(
                        logging.warning,
                        'less.logging.LogHandler emit took too long'
