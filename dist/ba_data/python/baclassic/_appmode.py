...
if TYPE_CHECKING:
    ...
    from less.call import CallbackRegistration
...
class ClassicAppMode(AppMode):
    ...
    def _root_ui_store_press(self) -> None:
        ...
        if v3_token:
            from bauiv1lib.account.v3store import V3StoreWindow
            V3StoreWindow(origin_widget=btn)
            return

        from bauiv1lib.account.signin import show_sign_in_prompt
        show_sign_in_prompt(origin_widget=btn)
