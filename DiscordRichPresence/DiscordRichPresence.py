...
VERSION = "1.1.4"
UPDATE_URL = "https://raw.githubusercontent.com/danigomezdev/bombsquad/refs/heads/main/DiscordRichPresence/DiscordRichPresence.json"
...
class UpdateWindow(bui.Window):
    ...
    def _rd(s, info):
        ...
        try:
            ...
            with open(os.path.join(_E["python_directory_user"], "DiscordRichPresence.py"), "wb") as f: f.write(c)
