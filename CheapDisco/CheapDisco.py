...
class UpdateWindow(bui.Window):
    def __init__(s, start_check=True):
        ...
        s._auto_update = bui.app.config.get("AutoUpdate_CheapDisco", False)
        ...
        bui.checkboxwidget(parent=s._root_widget, position=(w-150, 42), size=(140, 30),
